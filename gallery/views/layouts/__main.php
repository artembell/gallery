...
<head>
    ...
    <meta name="description" content="Webpic - the largest photo service" />
    <meta name="keywords" content="html5, css3, mobile first, responsive" />
    <meta name="author" content="Webpic Corp's" />
    <?= Html::csrfMetaTags() ?>
...
<div id="fh5co-offcanvass">
    ...
    <h1 class="fh5co-logo"><a class="navbar-brand" href="index.html">Webpic</a></h1>
    <ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <a class="navbar-brand" href="index.html">Webpic</a>
            </div>
        </div>
    </div>
</header>
            ...
            <div id="fh5co-board" data-columns>
                ...
                <div class="item">
                    <div class="animate-box">
                        <a href="images/img_1.jpg" class="image-popup fh5co-board-img" title="Loremmmmm ipsum dolor sit amet, consectetur adipisicing elit. Explicabo, eos?"><img src="images/img_1.jpg" alt="Free HTML5 Bootstrap template"></a>
                    </div>
    ...
    <div class="container">
        <div class="row row-padded">
            <div class="col-md-12 text-center">
                ...
                <p><small>&copy; Webpic Corp's Production. All Rights Reserved. <br>Designed by: <a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a> | Images by: <a href="http://pexels.com" target="_blank">Pexels</a> </small></p>
            </div>
        </div>
    </div>
</footer>
